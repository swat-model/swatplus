      ...
      type constituent_rct
        ...
        real :: oxy_aqu = 0.                                !! |mg/L       |oxygen concentration in groundwater
				real :: latfrct = 0.                                !! |           |fraction of constituent mass allowed to be transported via soil lateral flow
				real :: surfrct = 0.                                !! |           |fraction of constituent mass in top layer allowed to be transported via surface runoff
      ...
      real, dimension (:), allocatable :: bor_stress_a         !      |a parameter in boron relative yield equations
			real, dimension (:), allocatable :: bor_stress_b         !      |b parameter in boron relative yield equations
