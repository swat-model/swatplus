      ...
      type constituent_rct
        ...
        real :: oxy_aqu                                     !! |mg/L       |oxygen concentration in groundwater
				real :: latfrct                                     !! |           |fraction of constituent mass allowed to be transported via soil lateral flow
				real :: surfrct                                     !! |           |fraction of constituent mass in top layer allowed to be transported via surface runoff
