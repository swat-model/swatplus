      ...
      !!MIKE NAM OUTPUTS CH_BUDGET.TXT 
      type ch_header_nam1    
          character (len=12)  :: id = "       chan "                                        
          character (len=16) :: name =  " name          "
          character(len=16)  :: area  = "       area    "      
          character(len=15)  :: width = "      width    "      
          character(len=15)  :: wyr =   "       w/yr    "      
          character(len=15)  :: depth = "     depth     "      
          character(len=15)  :: dyr =   "      d/yr     "       
          character(len=15)  :: fp_dep= "     fp_dep    "      
      end type ch_header_nam1
      type (ch_header_nam1) :: ch_hdr_nam1
      
      type ch_header_nam1_units     
          character (len=12)  :: id = "         -- "                                        
          character (len=16) :: name =  "   --           "
