...
!!!!! daily print
       if (pco%day_print == "y" .and. pco%int_day_cur == pco%int_day) then
        if (pco%wb_hru%d == "y") then   !!using region water balance print codes for now
          write (3110,100) time%day, time%mo, time%day_mo, time%yrc, idmd, wallo(iwallo)%dmd(idmd)%ob_typ,                &
              ...
              (wallo(iwallo)%src(isrc)%ob_typ, wallo(iwallo)%src(isrc)%ob_num,                                            &                                            
              wallod_out(iwallo)%dmd(idmd)%src(isrc), isrc = 1, wallo(iwallo)%src_obs)  
...
!!!!! monthly print
        if (time%end_mo == 1) then
          ...
          write (3111,100) time%day, time%mo, time%day_mo, time%yrc, idmd, wallo(iwallo)%dmd(idmd)%ob_typ,                &
              wallo(iwallo)%dmd(idmd)%ob_num, wallo(iwallo)%dmd(idmd)%dmd_src_obs,                                        &                                        
              (wallo(iwallo)%src(isrc)%ob_typ, wallo(iwallo)%src(isrc)%ob_num,                                            &                                            
              wallom_out(iwallo)%dmd(idmd)%src(isrc), isrc = 1, wallo(iwallo)%src_obs)           
      ...
      if (time%end_yr == 1) then
        ...
        if (pco%wb_hru%y == "y") then
          write (3112,100) time%day, time%mo, time%day_mo, time%yrc, idmd, wallo(iwallo)%dmd(idmd)%ob_typ,                &
              wallo(iwallo)%dmd(idmd)%ob_num, wallo(iwallo)%dmd(idmd)%dmd_src_obs,                                        &                                        
              (wallo(iwallo)%src(isrc)%ob_typ, wallo(iwallo)%src(isrc)%ob_num,                                            &                                            
              walloy_out(iwallo)%dmd(idmd)%src(isrc), isrc = 1, wallo(iwallo)%src_obs)        
...
!!!!! average annual print
      if (time%end_sim == 1) then
        ...
        write (3113,100) time%day, time%mo, time%day_mo, time%yrc, idmd, wallo(iwallo)%dmd(idmd)%ob_typ,                &
              wallo(iwallo)%dmd(idmd)%ob_num, wallo(iwallo)%dmd(idmd)%dmd_src_obs,                                        &                                        
              (wallo(iwallo)%src(isrc)%ob_typ, wallo(iwallo)%src(isrc)%ob_num,                                            &                                            
              walloa_out(iwallo)%dmd(idmd)%src(isrc), isrc = 1, wallo(iwallo)%src_obs)        
