    ...
    !! RESERVOIR
      if (pco%res%d == "y" .and. sp_ob%res > 0 ) then
        ...
        write (2540,*) ch_wbod_hdr_units, hyd_hdr_units1_res, hyd_hdr_units1_res, hyd_hdr_units1_res
          if (pco%csvout == "y") then
            ...
            write (2544,'(*(G0.3,:","))') ch_wbod_hdr_units, hyd_hdr_units1_res, hyd_hdr_units1_res, hyd_hdr_units1_res
     ...
     if (pco%res%m == "y" .and. sp_ob%res > 0 ) then
        ...
        write (2541,*) ch_wbod_hdr_units, hyd_hdr_units1_res, hyd_hdr_units1_res, hyd_hdr_units1_res
           if (pco%csvout == "y") then
            ...
            write (2545,'(*(G0.3,:","))') ch_wbod_hdr_units, hyd_hdr_units1_res, hyd_hdr_units1_res, hyd_hdr_units1_res
     ...
     if (pco%res%y == "y" .and. sp_ob%res > 0 ) then
        ...
        write (2542,*) ch_wbod_hdr_units, hyd_hdr_units1_res, hyd_hdr_units1_res, hyd_hdr_units1_res
          if (pco%csvout == "y") then
            ...
            write (2546,'(*(G0.3,:","))') ch_wbod_hdr_units, hyd_hdr_units1_res, hyd_hdr_units1_res, hyd_hdr_units1_res
      ...
      if (pco%res%a == "y" .and. sp_ob%res > 0) then
        ...
        write (2543,*) ch_wbod_hdr_units, hyd_hdr_units1_res, hyd_hdr_units1_res, hyd_hdr_units1_res
        write (9000,*) "RES                       reservoir_aa.txt"
          if (pco%csvout == "y") then
            ...
            write (2547,'(*(G0.3,:","))') ch_wbod_hdr_units, hyd_hdr_units1_res, hyd_hdr_units1_res, hyd_hdr_units1_res
