...
Markdown, or verify an existing Markdown call tree against the source.
...
Usage (run from project root):
  ...
  python analysis/swat_calltree.py --generate out.md --verify doc/swatplus_call_tree.md

Options:
  --src DIR       Fortran source directory  (default: ./src)
  --start SUB     Root subroutine           (default: main)
  --generate FILE Write generated Markdown to FILE
...
# ===========================================================================
# STEP 4: Verification against existing Markdown
# ===========================================================================
...
def main():
    ap = argparse.ArgumentParser(
        description='SWAT+ Fortran call tree — generate Markdown or verify existing doc',
    ...
    ap.add_argument('--generate', metavar='FILE',
                    help='Write generated Markdown to FILE')
    ...
    if args.generate:
        print(f'Generating {args.generate} ...', file=sys.stderr)
